...
function Dc(e, n, t, r, l, i, o, u, s) {
  (Et = !1), (Lr = null), Oc.apply(Ic, arguments);
}
...
var Cf = We && 'TextEvent' in window && !xt,
  Os = We && (!no || (xt && 8 < xt && 11 >= xt)),
  qo = ' ',
  bo = !1;
function Is(e, n) {
  switch (e) {
...
function tu() {
  _t && (_t.detachEvent('onpropertychange', $s), (Dt = _t = null));
}
function $s(e) {
  if (e.propertyName === 'value' && tl(Dt)) {
    var n = [];
    Fs(n, Dt, e, Yi(e)), gs(Tf, n);
  }
}
function jf(e, n, t) {
  e === 'focusin'
    ? (tu(), (_t = n), (Dt = t), _t.attachEvent('onpropertychange', $s))
    : e === 'focusout' && tu();
}
function Rf(e) {
      ...
      N &&
        (Os &&
          ...
          (In || N !== 'onCompositionStart'
            ? N === 'onCompositionEnd' && In && (C = Ms())
            : ((en = h),
              (qi = 'value' in en ? en.value : en.textContent),
              (In = !0))),
        (_ = Dr(c, N)),
        0 < _.length &&
          ((N = new Zo(N, e, null, t, h)),
          m.push({ event: N, listeners: _ }),
          C ? (N.data = C) : ((C = Ds(t)), C !== null && (N.data = C)))),
        (C = Cf ? Nf(e, t) : Pf(e, t)) &&
...
function D(e) {
  0 > $n || ((e.current = vi[$n]), (vi[$n] = null), $n--);
}
function O(e, n) {
  $n++, (vi[$n] = e.current), (e.current = n);
}
var dn = {},
  le = mn(dn),
  fe = mn(!1),
...
function hn() {
  if (!Il && Ve !== null) {
    ...
    try {
      ...
      throw (Ve !== null && (Ve = Ve.slice(e + 1)), Es(Xi, hn), l);
    } finally {
      (M = n), (Il = !1);
    }
  }
...
function na(e) {
  ...
  function w(f, a, d, v) {
    ...
    if (C === null) {
      for (; N < d.length; N++)
        (C = m(f, d[N], v)),
          C !== null &&
            ((a = i(C, a, N)), _ === null ? (E = C) : (_.sibling = C), (_ = C));
      return U && gn(f, N), E;
    }
  ...
  function k(f, a, d, v) {
    ...
    for (
      var _ = (E = null), C = a, N = (a = 0), H = null, j = d.next();
      C !== null && !j.done;
      N++, j = d.next()
    ) {
      C.index > N ? ((H = C), (C = null)) : (H = C.sibling);
      var Ne = p(f, C, j.value, v);
      if (Ne === null) {
        C === null && (C = H);
        break;
      }
    ...
    if (j.done) return t(f, C), U && gn(f, N), E;
    if (C === null) {
      for (; !j.done; N++, j = d.next())
        (j = m(f, j.value, v)),
          j !== null &&
            ((a = i(j, a, N)), _ === null ? (E = j) : (_.sibling = j), (_ = j));
      return U && gn(f, N), E;
    }
...
function ka(e, n, t) {
  return Pn & 21
    ? (Me(t, n) || ((t = Cs()), (V.lanes |= t), (zn |= t), (e.baseState = !0)),
      n)
...
function zu(e, n, t, r, l) {
  ...
  if ((Gn(n, l), n.stateNode === null))
    Cr(e, n), Ca(n, t, r), Si(n, t, r, l), (r = !0);
  else if (e === null) {
    var o = n.stateNode,
      u = n.memoizedProps;
    o.props = u;
  ...
  if (t)
    return n.flags & 256
      ...
      : ((i = r.fallback),
        ...
        (n.child.memoizedState = Ni(o)),
        (n.memoizedState = Ci),
        i);
  if (!(n.mode & 1)) return pr(e, n, o, null);
  if (l.data === '$!') {
    if (((r = l.nextSibling && l.nextSibling.dataset), r)) var u = r.dgst;
    return (r = u), (i = Error(y(419))), (r = Vl(i, r, void 0)), pr(e, n, o, r);
  }
...
function cd(e, n) {
  ...
  for (di = { focusedElem: e, selectionRange: t }, Or = !1, S = n; S !== null; )
...
function Fa(e) {
  ...
  n !== null && ((e.alternate = null), Fa(n)),
    ...
    e.tag === 5 &&
      ((n = e.stateNode),
      n !== null &&
        (delete n[De], delete n[Vt], delete n[hi], delete n[Kf], delete n[Yf])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
          ...
          for (S = l; S !== null; )
            (o = S),
              ...
              o.tag === 22 && o.memoizedState !== null
                ...
                ? ((s.return = o), (S = s))
                : Du(l);
        for (; i !== null; ) (S = i), Aa(i), (i = i.sibling);
        (S = l), (mr = u), (re = c);
      }
      Ou(e);
    } else
...
function Ba(e, n) {
  ...
  if (n !== 0) {
    if (
      (n === 2 && ((l = oi(e)), l !== 0 && ((r = l), (n = Oi(e, l)))), n === 1)
    )
    ...
    if (n === 6) be(e, r);
      ...
      switch (((e.finishedWork = l), (e.finishedLanes = r), n)) {
        ...
        case 3:
          if (
            (be(e, r), (r & 130023424) === r && ((n = xo + 500 - Q()), 10 < n))
          ) {
            if (Mr(e, 0) !== 0) break;
            ...
            e.timeoutHandle = mi(wn.bind(null, e, ae, $e), n);
            break;
          }
          wn(e, ae, $e);
          break;
        case 4:
          ...
          if (
            ...
            e.timeoutHandle = mi(wn.bind(null, e, ae, $e), r);
            break;
          }
          wn(e, ae, $e);
          break;
...
function Tn(e) {
  ...
  try {
    ...
    (M = r), (xe.transition = t), (R = n), !(R & 6) && hn();
  }
}
function Co() {
  (me = Wn.current), D(Wn);
...
function Jr(e, n) {
  ...
  while (!0);
  if ((uo(), (R = t), (Xr.current = r), K !== null)) throw Error(y(261));
  return (J = null), (b = 0), X;
}
function md() {
  for (; K !== null; ) Qa(K);
...
function wn(e, n, t) {
  var r = M,
    l = xe.transition;
  try {
    (xe.transition = null), (M = 1), vd(e, n, t, r);
  } finally {
    (xe.transition = l), (M = r);
  }
  return null;
...
function yd(e, n, t) {
  ...
  r !== null && r.delete(n),
    ...
    J === e &&
      (b & t) === t &&
      (X === 4 || (X === 3 && (b & 130023424) === b && 500 > Q() - xo)
        ? xn(e, 0)
        : (Eo |= t)),
    pe(e, n);
}
...
function zr(e, n, t, r, l, i) {
  ...
  if (((r = e), typeof e == 'function')) Po(e) && (o = 1);
    ...
    e: switch (e) {
      ...
      case Ql:
        return (
          (e = Ee(12, t, n, l | 2)), (e.elementType = Ql), (e.lanes = i), e
        );
      case Kl:
        return (e = Ee(13, t, n, l)), (e.elementType = Kl), (e.lanes = i), e;
      case Yl:
        return (e = Ee(19, t, n, l)), (e.elementType = Yl), (e.lanes = i), e;
      case is:
        return cl(t, l, i, n);
      default:
  ...
  switch (e.tag) {
    case 3:
      ...
      if (n.current.memoizedState.isDehydrated) {
        ...
        t !== 0 &&
          (Gi(n, t | 1), pe(n, Q()), !(R & 6) && ((rt = Q() + 500), hn()));
      }
      break;
    case 13:
      Tn(function () {
...
vs = _o;
ys = Tn;
var Nd = { usingClientEntryPoint: !1, Events: [Zt, Un, ll, ms, hs, _o] },
  vt = {
  ...
  return z.jsxs(z.Fragment, {
    children: [
      z.jsx('div', {
        ...
        children: z.jsx('h1', {
          className: 'londrina-sketch-regular',
          children: 'JUJUPPS JUICEBOX',
        }),
      }),
      z.jsx('div', { className: 'underline' }),
      z.jsxs('div', {
        ...
        children: [
          z.jsxs('div', {
            className: 'container',
            children: [
              z.jsx('img', { src: './assets/paint.svg' }),
              z.jsx('span', {
                className: 'dynapuff-regular',
                children: 'Projects',
              }),
            ],
          }),
          z.jsxs('div', {
            className: 'container',
            children: [
              z.jsx('img', { src: './assets/about-me.svg' }),
              z.jsx('span', {
                className: 'dynapuff-regular',
                children: 'About Me',
              }),
          ...
          z.jsxs('div', {
            className: 'container',
            children: [
              z.jsx('img', { src: './assets/stalls.svg' }),
              z.jsx('span', {
                className: 'dynapuff-regular',
                children: 'Stalls',
              }),
              ...
              z.jsx('div', {
                ...
                children: z.jsxs('select', {
                  ...
                  children: [
                    ...
                    z.jsx('option', {
                      children: "I'd like to start a project",
                    }),
                    z.jsx('option', { children: "I'd like to ask a question" }),
                    z.jsx('option', {
                      children: "I'd like to make a proposal",
                    }),
                  ],
                }),
              }),
      ...
      z.jsxs('footer', {
        children: [
          'Photo by ',
          z.jsx('a', {
            href: '/photographer/johnnyberg-50785',
            children: 'johnnyberg',
          }),
          ' on',
          ' ',
          z.jsx('a', { href: '/', children: 'Freeimages.com' }),
        ],
      }),
    ],
  });
...
ec(document.getElementById('root')).render(
  z.jsx(Vi.StrictMode, { children: z.jsx(Td, {}) })
);
new p5((e) => {
  let n,
    l = [],
    ...
    o;
  (e.preload = function () {
    o = e.loadImage('/jujupps/assets/soot.png');
  }),
    (e.setup = function () {
      (n = e.createCanvas(e.windowWidth, e.windowHeight)),
        n.position(0, 0),
        n.style('z-index', '-2');
      for (let u = 0; u < 10; ++u) {
        let s,
        ...
        for (; c; )
          (c = !1),
            (s = e.createVector(
              e.random(e.width * 0.1, e.width * 0.9),
              e.random(e.height * 0.1, e.height * 0.9)
            )),
            l.forEach((m) => {
              p5.Vector.dist(s, m) < 150 &&
                ((c = !0), console.log('too close'));
            });
        i.push(p5.Vector.add(s, e.createVector(8, 0)));
        let h = e.createVector(40 * 0.52, 0);
        l.push(p5.Vector.add(s, h)), l.push(p5.Vector.sub(s, h));
      }
      e.rectMode(e.CENTER), e.imageMode(e.CENTER), e.background(248, 99, 237);
    }),
    (e.draw = function () {
      e.noStroke(),
        e.fill(248, 99, 237, 10),
        e.rect(e.width / 2, e.height / 2, e.width, e.height);
      let u = e.createVector(e.mouseX, e.mouseY);
      e.strokeWeight(3),
        i.forEach((s) => {
          e.image(o, s.x, s.y);
        }),
        l.forEach((s) => {
          e.fill(255), e.circle(s.x, s.y, 40);
          let c = p5.Vector.sub(u, s);
          c
            .normalize()
            .mult(
              e.constrain(
                e.map(p5.Vector.dist(u, s), 0, 40, 0, 40 / 2 - 15 / 2),
                0,
                40 / 2 - 15 / 2
              )
            ),
    ...
    (e.mouseDragged = () => {
      e.stroke(0),
        e.strokeWeight(3),
        e.line(e.pmouseX, e.pmouseY, e.mouseX, e.mouseY);
    }),
    (e.windowResized = () => {
      e.resizeCanvas(e.windowWidth, e.windowHeight);
    });
});
